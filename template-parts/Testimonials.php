    ...
    <div class="testimonials-swiper-section">
        ...
        <div class="testimonials-swiper-wrapper testimonials-swiper-top">
            <div class="testimonials-swiper-container">
                <div class="testimonials-track testimonials-track-top">
                    <?php
                    // Reverse array for right-to-left (top swiper)
                    $top_testimonials = array_reverse($testimonials);
                    // Duplicate for seamless infinite loop
                    $top_testimonials_duplicated = array_merge($top_testimonials, $top_testimonials);
                    foreach ($top_testimonials_duplicated as $testimonial):
                        ?>
        ...
        <div class="testimonials-swiper-wrapper testimonials-swiper-bottom">
            <div class="testimonials-swiper-container">
                <div class="testimonials-track testimonials-track-bottom">
                    <?php 
                    // Duplicate for seamless infinite loop
                    $bottom_testimonials_duplicated = array_merge($testimonials, $testimonials);
                    foreach ($bottom_testimonials_duplicated as $testimonial): ?>
                        <div class="testimonial-slide">
                            <div class="testimonial-card">
                                <p class="testimonial-review"><?php echo esc_html($testimonial['review']); ?></p>
                                <div class="testimonial-author">
